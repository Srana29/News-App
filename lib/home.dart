...
import 'package:mynewsapp/category.dart';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: isLoading ? Container(height:200,child: Center(child: CircularProgressIndicator())) :
              CarouselSlider(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Category(Query: "LATEST NEWS")));
